...
RECONCILE_CHECKED_SETTINGS_ON_WEBHOOK = (
    os.environ.get("RECONCILE_CHECKED_SETTINGS_ON_WEBHOOK", "true").lower() == "true"
)
RECONCILE_CHECKED_SETTINGS_COOLDOWN_SECONDS = int(
    os.environ.get("RECONCILE_CHECKED_SETTINGS_COOLDOWN_SECONDS", "30")
)
RECONCILE_CHECKED_SETTINGS_LIMIT = int(
    os.environ.get("RECONCILE_CHECKED_SETTINGS_LIMIT", "25")
)
